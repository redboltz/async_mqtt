...
== 6.0.0
=== breaking changes
* Added `async_` prefix to all async functions to support default completion token. #238
...
* Removed buffer from packet interface except the infterface for adcanced user. #195
...
=== other updates
* client supported flexible parameters. #241
...
* Used bound allocator to allocate buffer for packet on receive. #222
...
* Refined documents. #220, #222, #232, #233, #234, #235
* Refined examples. #214, #220
