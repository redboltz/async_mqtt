...
#if !defined(ASYNC_MQTT_PACKET_IMPL_V5_PUBCOMP_HPP)
#define ASYNC_MQTT_PACKET_IMPL_V5_PUBCOMP_HPP
...
template <std::size_t PacketIdBytes>
inline
constexpr control_packet_type basic_pubcomp_packet<PacketIdBytes>::type() {
...
template <std::size_t PacketIdBytes>
inline
constexpr std::size_t basic_pubcomp_packet<PacketIdBytes>::num_of_const_buffer_sequence() const {
    return
        1 +                   // fixed header
        1 +                   // remaining length
        1 +                   // packet_id
...
#endif // ASYNC_MQTT_PACKET_IMPL_V5_PUBCOMP_HPP
