...
#if !defined(ASYNC_MQTT_PACKET_IMPL_V3_1_1_PUBACK_IPP)
#define ASYNC_MQTT_PACKET_IMPL_V3_1_1_PUBACK_IPP
...
template bool operator<(basic_puback_packet<a_size> const& lhs, basic_puback_packet<a_size> const& rhs); \
template std::ostream& operator<<(std::ostream& o, basic_puback_packet<a_size> const& v);
...
#endif // ASYNC_MQTT_PACKET_IMPL_V3_1_1_PUBACK_IPP
