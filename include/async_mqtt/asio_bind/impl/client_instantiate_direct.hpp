...
#if !defined(ASYNC_MQTT_ASIO_BIND_IMPL_CLIENT_INSTANTIATE_DIRECT_HPP)
#define ASYNC_MQTT_ASIO_BIND_IMPL_CLIENT_INSTANTIATE_DIRECT_HPP
...
#endif // ASYNC_MQTT_ASIO_BIND_IMPL_CLIENT_INSTANTIATE_DIRECT_HPP
