...
#if !defined(ASYNC_MQTT_PROTOCOL_IMPL_EVENT_CONNECTION_HPP)
#define ASYNC_MQTT_PROTOCOL_IMPL_EVENT_CONNECTION_HPP
...
#endif // ASYNC_MQTT_PROTOCOL_IMPL_EVENT_CONNECTION_HPP
