...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_DETAIL_BASE_PROPERTY_HPP)
#define ASYNC_MQTT_PROTOCOL_PACKET_DETAIL_BASE_PROPERTY_HPP
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_DETAIL_BASE_PROPERTY_HPP
