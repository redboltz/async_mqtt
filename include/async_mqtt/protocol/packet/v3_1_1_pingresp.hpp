...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_V3_1_1_PINGRESP_HPP)
 ...
 *
 * #### Requirements
 * @li Header: async_mqtt/protocol/packet/v3_1_1_pingresp.hpp
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_V3_1_1_PINGRESP_HPP
