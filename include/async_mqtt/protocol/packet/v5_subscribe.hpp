...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_V5_SUBSCRIBE_HPP)
#define ASYNC_MQTT_PROTOCOL_PACKET_V5_SUBSCRIBE_HPP
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_V5_SUBSCRIBE_HPP
