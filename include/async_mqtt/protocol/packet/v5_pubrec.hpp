...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_V5_PUBREC_HPP)
#define ASYNC_MQTT_PROTOCOL_PACKET_V5_PUBREC_HPP
 ...
 *
 * #### Requirements
 * @li Header: async_mqtt/protocol/packet/v5_pubrec.hpp
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_V5_PUBREC_HPP
