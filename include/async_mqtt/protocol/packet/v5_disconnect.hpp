...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_V5_DISCONNECT_HPP)
#define ASYNC_MQTT_PROTOCOL_PACKET_V5_DISCONNECT_HPP
 ...
 *
 * #### Requirements
 * @li Header: async_mqtt/protocol/packet/v5_disconnect.hpp
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_V5_DISCONNECT_HPP
