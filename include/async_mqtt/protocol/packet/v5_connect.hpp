...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_V5_CONNECT_HPP)
#define ASYNC_MQTT_PROTOCOL_PACKET_V5_CONNECT_HPP
 ...
 *
 * #### Requirements
 * @li Header: async_mqtt/protocol/packet/v5_connect.hpp
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_V5_CONNECT_HPP
