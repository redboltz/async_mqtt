...
#if !defined(ASYNC_MQTT_PACKET_IMPL_V3_1_1_PUBCOMP_IPP)
#define ASYNC_MQTT_PACKET_IMPL_V3_1_1_PUBCOMP_IPP
...
basic_pubcomp_packet<PacketIdBytes>::basic_pubcomp_packet(
    ...
    : all_(all_.capacity())
{
    all_[0] = static_cast<char>(detail::make_fixed_header(control_packet_type::pubcomp, 0b0000));
...
template bool operator<(basic_pubcomp_packet<a_size> const& lhs, basic_pubcomp_packet<a_size> const& rhs); \
template std::ostream& operator<<(std::ostream& o, basic_pubcomp_packet<a_size> const& v);
...
#endif // ASYNC_MQTT_PACKET_IMPL_V3_1_1_PUBCOMP_IPP
