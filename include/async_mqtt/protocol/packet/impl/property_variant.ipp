...
#if !defined(ASYNC_MQTT_PACKET_IMPL_PROPERTY_VARIANT_IPP)
#define ASYNC_MQTT_PACKET_IMPL_PROPERTY_VARIANT_IPP
...
#endif // ASYNC_MQTT_PACKET_IMPL_PROPERTY_VARIANT_IPP
