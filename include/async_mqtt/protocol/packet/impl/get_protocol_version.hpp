...
#if !defined(ASYNC_MQTT_PROTOCOL_PACKET_IMPL_GET_PROTOCOL_VERSION_HPP)
#define ASYNC_MQTT_PROTOCOL_PACKET_IMPL_GET_PROTOCOL_VERSION_HPP
...
#endif // ASYNC_MQTT_PROTOCOL_PACKET_IMPL_GET_PROTOCOL_VERSION_HPP
