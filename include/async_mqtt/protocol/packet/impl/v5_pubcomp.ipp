...
#if !defined(ASYNC_MQTT_PACKET_IMPL_V5_PUBCOMP_IPP)
#define ASYNC_MQTT_PACKET_IMPL_V5_PUBCOMP_IPP
...
template <std::size_t PacketIdBytes>
ASYNC_MQTT_HEADER_ONLY_INLINE
std::vector<as::const_buffer> basic_pubcomp_packet<PacketIdBytes>::const_buffer_sequence() const {
...
template <std::size_t PacketIdBytes>
ASYNC_MQTT_HEADER_ONLY_INLINE
std::size_t basic_pubcomp_packet<PacketIdBytes>::size() const {
    return
        1 +                            // fixed header
...
template <std::size_t PacketIdBytes>
ASYNC_MQTT_HEADER_ONLY_INLINE
std::size_t basic_pubcomp_packet<PacketIdBytes>::num_of_const_buffer_sequence() const {
    return
        1 +                   // fixed header
        1 +                   // remaining length
        1 +                   // packet_id
...
template <std::size_t PacketIdBytes>
ASYNC_MQTT_HEADER_ONLY_INLINE
pubcomp_reason_code basic_pubcomp_packet<PacketIdBytes>::code() const {
...
template <std::size_t PacketIdBytes>
ASYNC_MQTT_HEADER_ONLY_INLINE
properties const& basic_pubcomp_packet<PacketIdBytes>::props() const {
    return props_;
}
...
basic_pubcomp_packet<PacketIdBytes>::basic_pubcomp_packet(
    ...
    : fixed_header_{
          detail::make_fixed_header(control_packet_type::pubcomp, 0b0000)
      },
      remaining_length_{
          PacketIdBytes
      },
...
template class basic_pubcomp_packet<a_size>; \
template bool operator==(basic_pubcomp_packet<a_size> const& lhs, basic_pubcomp_packet<a_size> const& rhs); \
template bool operator<(basic_pubcomp_packet<a_size> const& lhs, basic_pubcomp_packet<a_size> const& rhs);
...
#endif // ASYNC_MQTT_PACKET_IMPL_V5_PUBCOMP_IPP
