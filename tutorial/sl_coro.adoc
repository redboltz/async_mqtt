...
== Send/Recv packets
See the simple example xref:../../main/example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp].

If you want to know more complex usecase, xref:../../main/tool/client_cli.cpp[client_cli.cpp] is helpful.
...
* xref:../../main/example/ep_slcoro_mqtts_client.cpp[ep_slcoro_mqtts_client.cpp]
* xref:../../main/example/ep_slcoro_ws_client.cpp[ep_slcoro_ws_client.cpp]
* xref:../../main/example/ep_slcoro_wss_client.cpp[ep_slcoro_wss_client.cpp]
