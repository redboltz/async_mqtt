...
See xref:https://redboltz.github.io/async_mqtt/doc/latest/html/$$classasync__mqtt_1_1basic__endpoint$$.html[API reference].
...
ifdef::env-github[xref:../../main/example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp]]
ifndef::env-github[xref:../../../example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp]]
.

If you want to know more complex usecase,
ifdef::env-github[xref:../../main/tool/client_cli.cpp[client_cli.cpp]]
ifndef::env-github[xref:../../../tool/client_cli.cpp[client_cli.cpp]]
is helpful.
This is commandline MQTT client application.

== Examples
ifdef::env-github[* xref:../../../example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp]]
ifdef::env-github[* xref:../../../example/ep_slcoro_mqtts_client.cpp[ep_slcoro_mqtts_client.cpp]]
ifdef::env-github[* xref:../../../example/ep_slcoro_ws_client.cpp[ep_slcoro_ws_client.cpp]]
ifdef::env-github[* xref:../../../example/ep_slcoro_wss_client.cpp[ep_slcoro_wss_client.cpp]]
ifndef::env-github[* xref:../../main/example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp]]
ifndef::env-github[* xref:../../main/example/ep_slcoro_mqtts_client.cpp[ep_slcoro_mqtts_client.cpp]]
ifndef::env-github[* xref:../../main/example/ep_slcoro_ws_client.cpp[ep_slcoro_ws_client.cpp]]
ifndef::env-github[* xref:../../main/example/ep_slcoro_wss_client.cpp[ep_slcoro_wss_client.cpp]]
