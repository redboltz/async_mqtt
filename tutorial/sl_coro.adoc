...
If you can use link:cpp20_coro.adoc[C++20 coroutine], I recommend use it.
...
See link:https://redboltz.github.io/async_mqtt/doc/latest/html/$$classasync__mqtt_1_1basic__endpoint$$.html[API reference].
...
== Send/Recv packets
See the simple example link:../../main/example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp].

If you want to know more complex usecase, link:../../main/tool/client_cli.cpp[client_cli.cpp] is helpful.
This is commandline MQTT client application.

= Examples
* link:../../main/example/ep_slcoro_mqtt_client.cpp[ep_slcoro_mqtt_client.cpp]
* link:../../main/example/ep_slcoro_mqtts_client.cpp[ep_slcoro_mqtts_client.cpp]
* link:../../main/example/ep_slcoro_ws_client.cpp[ep_slcoro_ws_client.cpp]
* link:../../main/example/ep_slcoro_wss_client.cpp[ep_slcoro_wss_client.cpp]
