...
BOOST_AUTO_TEST_CASE(v311_pingresp) {
    ...
    BOOST_TEST(am::is_v3_1_1<am::v3_1_1::pingresp_packet>());
    BOOST_TEST(!am::is_v5<am::v3_1_1::pingresp_packet>());
    BOOST_TEST(!am::is_client_sendable<am::v3_1_1::pingresp_packet>());
    BOOST_TEST(am::is_server_sendable<am::v3_1_1::pingresp_packet>());
...

    {
        ...
        am::error_code ec;
        auto p = am::v3_1_1::pingresp_packet{buf, ec};
        BOOST_TEST(!ec);
        ...
        BOOST_TEST(p.type() == am::control_packet_type::pingresp);
    }
    BOOST_TEST(
    ...
    auto p2 = am::v3_1_1::pingresp_packet{};
    BOOST_CHECK(p == p2);
    BOOST_CHECK(!(p < p2));
    BOOST_CHECK(!(p2 < p));
}

BOOST_AUTO_TEST_CASE(v311_pingresp_error) {
    {
        am::buffer buf; // empty
        am::error_code ec;
        am::v3_1_1::pingresp_packet{buf, ec};
    ...
    {
        am::buffer buf{"\xd0"sv}; // short
        am::error_code ec;
        am::v3_1_1::pingresp_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        am::buffer buf{"\xd0\x01"sv}; // invalid remaining length
        am::error_code ec;
        am::v3_1_1::pingresp_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        am::buffer buf{"\xd0\x00"sv}; // valid
        am::error_code ec;
        am::v3_1_1::pingresp_packet{buf, ec};
