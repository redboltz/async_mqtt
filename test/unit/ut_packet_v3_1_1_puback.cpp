...
BOOST_AUTO_TEST_CASE(v311_puback) {
    ...
    BOOST_TEST(am::is_v3_1_1<am::v3_1_1::puback_packet>());
    BOOST_TEST(!am::is_v5<am::v3_1_1::puback_packet>());
    BOOST_TEST(am::is_client_sendable<am::v3_1_1::puback_packet>());
    BOOST_TEST(am::is_server_sendable<am::v3_1_1::puback_packet>());
...

    {
        ...
        am::error_code ec;
        auto p = am::v3_1_1::puback_packet{buf, ec};
        BOOST_TEST(!ec);
        BOOST_TEST(p.packet_id() == 0x1234);
    ...
    BOOST_TEST(
        ...
        "v3_1_1::puback{pid:4660}"
    );

    auto p2 = am::v3_1_1::puback_packet{
        0x1234 // packet_id
    };
    auto p3 = am::v3_1_1::puback_packet{
        0x1235 // packet_id
    };
    BOOST_CHECK(p == p2);
    BOOST_CHECK(!(p < p2));
...
BOOST_AUTO_TEST_CASE(v311_puback_pid4) {
    auto p = am::v3_1_1::basic_puback_packet<4>{
...

    {
        ...
        am::buffer buf{std::begin(expected), std::end(expected)};
        am::error_code ec;
        auto p = am::v3_1_1::basic_puback_packet<4>{buf, ec};
        BOOST_TEST(!ec);
        BOOST_TEST(p.packet_id() == 0x12345678);
    ...
    BOOST_TEST(
        boost::lexical_cast<std::string>(p) ==
        "v3_1_1::puback{pid:305419896}"
    );
}

BOOST_AUTO_TEST_CASE(v311_puback_error) {
    {
        am::buffer buf; // empty
        am::error_code ec;
        am::v3_1_1::puback_packet{buf, ec};
    ...
    {
        //                CP  RL  PID
        am::buffer buf{"\x40\x02\x12\x34\x56"sv}; // too long
        am::error_code ec;
        am::v3_1_1::puback_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
