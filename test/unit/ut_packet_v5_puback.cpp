...
BOOST_AUTO_TEST_CASE(v5_puback) {
    ...
    BOOST_TEST(!am::is_v3_1_1<am::v5::puback_packet>());
    BOOST_TEST(am::is_v5<am::v5::puback_packet>());
    BOOST_TEST(am::is_client_sendable<am::v5::puback_packet>());
    BOOST_TEST(am::is_server_sendable<am::v5::puback_packet>());
...
BOOST_AUTO_TEST_CASE(v5_puback_pid4) {
    ...
    auto p = am::v5::basic_puback_packet<4>{
    ...
    BOOST_TEST(
        boost::lexical_cast<std::string>(p) ==
        "v5::puback{pid:305419896,rc:packet_identifier_in_use,ps:[{id:reason_string,val:some reason}]}"
    );
}

BOOST_AUTO_TEST_CASE(v5_puback_pid_only) {
    auto p = am::v5::puback_packet{
        0x1234 // packet_id
    };
