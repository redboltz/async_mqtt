...
BOOST_AUTO_TEST_CASE(v311_pubrel) {
    ...
    BOOST_TEST(am::is_v3_1_1<am::v3_1_1::pubrel_packet>());
    BOOST_TEST(!am::is_v5<am::v3_1_1::pubrel_packet>());
    BOOST_TEST(am::is_client_sendable<am::v3_1_1::pubrel_packet>());
    BOOST_TEST(am::is_server_sendable<am::v3_1_1::pubrel_packet>());
...

    {
        ...
        am::error_code ec;
        auto p = am::v3_1_1::pubrel_packet{buf, ec};
        BOOST_TEST(!ec);
        BOOST_TEST(p.packet_id() == 0x1234);
...
BOOST_AUTO_TEST_CASE(v311_pubrel_pid4) {
    auto p = am::v3_1_1::basic_pubrel_packet<4>{
...

    {
        ...
        am::buffer buf{std::begin(expected), std::end(expected)};
        am::error_code ec;
        auto p = am::v3_1_1::basic_pubrel_packet<4>{buf, ec};
        BOOST_TEST(!ec);
        BOOST_TEST(p.packet_id() == 0x12345678);
