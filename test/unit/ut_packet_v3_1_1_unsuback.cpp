...
BOOST_AUTO_TEST_CASE(v311_unsuback) {
    ...
    BOOST_TEST(am::is_v3_1_1<am::v3_1_1::unsuback_packet>());
    BOOST_TEST(!am::is_v5<am::v3_1_1::unsuback_packet>());
    BOOST_TEST(!am::is_client_sendable<am::v3_1_1::unsuback_packet>());
    BOOST_TEST(am::is_server_sendable<am::v3_1_1::unsuback_packet>());
    ...
    BOOST_TEST(
        ...
        "v3_1_1::unsuback{pid:4660}"
    );

    auto p2 = am::v3_1_1::unsuback_packet{
        0x1234         // packet_id
    };
    auto p3 = am::v3_1_1::unsuback_packet{
        0x1235         // packet_id
    };
    BOOST_CHECK(p == p2);
    BOOST_CHECK(!(p < p2));
...
BOOST_AUTO_TEST_CASE(v311_unsuback_pid4) {
    ...
    BOOST_TEST(
        boost::lexical_cast<std::string>(p) ==
        "v3_1_1::unsuback{pid:305419896}"
    );
}

BOOST_AUTO_TEST_CASE(v311_unsuback_error) {
    {
        am::buffer buf; // empty
        am::error_code ec;
        am::v3_1_1::unsuback_packet{buf, ec};
    ...
    {
        //                CP  RL  PID
        am::buffer buf{"\xb0\x02\x12\x34"sv}; // valid
        am::error_code ec;
        am::v3_1_1::unsuback_packet{buf, ec};
    ...
    {
        //                CP  RL  PID
        am::buffer buf{"\xb0\x02\x12\x34\x56"sv}; // too long
        am::error_code ec;
        am::v3_1_1::unsuback_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
