...
BOOST_AUTO_TEST_CASE(v5_pubrel) {
    ...
    auto p2 = am::v5::pubrel_packet{
        0x1234, // packet_id
        am::pubrel_reason_code::packet_identifier_not_found,
        props
    };
    auto p3 = am::v5::pubrel_packet{
        0x1235, // packet_id
        am::pubrel_reason_code::packet_identifier_not_found,
        props
    };
...
BOOST_AUTO_TEST_CASE(v5_pubrel_error) {
    {
        am::buffer buf; // empty
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
    ...
    {
        //                CP  RL  PID
        am::buffer buf{"\x62\x02\x12\x34\x00"sv}; // remaining length mismatch
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        //                CP  RL  PID     RC
        am::buffer buf{"\x62\x03\x12\x34\x00"sv}; // valid
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::errc::success);
    }
    {
        //                CP  RL  PID     RC
        am::buffer buf{"\x62\x03\x12\x34\x84"sv}; // invalid rc
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        //                CP  RL  PID     RC
        am::buffer buf{"\x62\x03\x12\x34\x00\x00"sv}; // remaining length mismatch
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        //                CP  RL  PID     RC  PL
        am::buffer buf{"\x62\x04\x12\x34\x00\x00"sv}; // valid
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::errc::success);
    }
    {
        //                CP  RL  PID     RC  PL
        am::buffer buf{"\x62\x05\x12\x34\x00\x00\x00"sv}; // property length mismatch
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        //                CP  RL  PID     RC  PL
        am::buffer buf{"\x62\x05\x12\x34\x00\x02\x00"sv}; // property length mismatch
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
    {
        //                CP  RL  PID     RC  PL
        am::buffer buf{"\x62\x07\x12\x34\x00\xff\xff\xff\x80"sv}; // over property length
        am::error_code ec;
        am::v5::pubrel_packet{buf, ec};
        BOOST_TEST(ec == am::disconnect_reason_code::malformed_packet);
    }
